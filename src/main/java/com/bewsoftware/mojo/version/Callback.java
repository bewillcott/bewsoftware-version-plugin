...
public interface Callback {
    ...
    /**
     * Process the {@code version} data.
     *
     * @param version data to process.
     *
     * @return {@code true} if version data changed, {@code false} otherwise.
     */
    boolean processVersion(final Version version);
}
