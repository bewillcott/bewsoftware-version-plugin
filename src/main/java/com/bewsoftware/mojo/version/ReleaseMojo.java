...
/**
 * ReleaseMojo class updates the {@code project.version} text, removing
 * "-SNAPSHOT".
 * <p>
 ...
 * <li>If '-SNAPSHOT' is there, then it is removed</li>
 * </ul><br>
...
public class ReleaseMojo extends AbstractVersionMojo
{
